    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('Orden Recivida', 'Orden Recivida'), ('Procesando Orden', 'Procesando Orden'), ('Orden en camino', 'Orden en camino'), ('Orden Completada', 'Orden Completada'), ('Orden Cancelada', 'Orden Cancelada')], max_length=50)),
